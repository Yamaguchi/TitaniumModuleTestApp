 ...
 * Copyright (c) 2009-2011 by ModuleTestApp, Inc. All Rights Reserved.
...
//@interface ModuleTestAppObject : NSObject
//@end

@interface ModuleTestAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ModuleTestAppObject class]])
		{
			for (NSString *key in [[(ModuleTestAppObject*)o modules] allKeys])
			{
