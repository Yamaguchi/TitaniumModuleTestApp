...
// in simulator we redefine to format for ModuleTestApp Developer console
...
{\
	NSString * exceptionName = [@"org.moduletestapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.moduletestapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIModuleTestAppNativeItemNone = -1, 
	UIModuleTestAppNativeItemSpinner = -2,
	UIModuleTestAppNativeItemProgressBar = -3,
	
	UIModuleTestAppNativeItemSlider = -4,
	UIModuleTestAppNativeItemSwitch = -5,
	UIModuleTestAppNativeItemMultiButton = -6,
	UIModuleTestAppNativeItemSegmented = -7,
	
	UIModuleTestAppNativeItemTextView = -8,
	UIModuleTestAppNativeItemTextField = -9,
	UIModuleTestAppNativeItemSearchBar = -10,
	
	UIModuleTestAppNativeItemPicker = -11,
	UIModuleTestAppNativeItemDatePicker = -12,
	
	UIModuleTestAppNativeItemInfoLight = -13,
	UIModuleTestAppNativeItemInfoDark = -14,
	
	UIModuleTestAppNativeItemDisclosure = -15,
	
	UIModuleTestAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ModuleTestApp instances of
