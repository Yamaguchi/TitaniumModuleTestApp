...
//Rare exceptions to indicate a bug in the _moduletestapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ModuleTestApp proxies.
 */
