...
/**
 The base class for all ModuleTestApp modules
 */
...
/**
 ModuleTestApp Platform calls this method on startup.
 */
-(void)startup;

/**
 ModuleTestApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ModuleTestApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ModuleTestApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
