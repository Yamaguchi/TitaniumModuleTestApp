...
@interface ModuleTestAppObject : KrollCoverageObject {
#else
@interface ModuleTestAppObject : KrollObject {
#endif
@private
...
extern NSString * ModuleTestApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ModuleTestAppObject *_moduletestapp;
	BOOL shutdown;
